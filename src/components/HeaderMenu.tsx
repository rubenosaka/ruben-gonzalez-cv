    ...
    <div className="flex w-full items-center justify-between rounded-b-2xl">
      ...
      <div className="relative ml-auto md:hidden">
        ...
        <div
          ...
          className={`absolute right-0 top-full z-50 mt-4 min-w-[12rem] rounded-xl border border-purple-950 bg-black shadow-lg transition-all duration-300 ease-in-out ${
            isMenuOpen
